...
const PageBanner = ({
  ...
  return (
    <>
      <div
        className={`h-[400px] bg-cover bg-no-repeat bg-center relative ${rounded && 'container mt-40 px-4 md:px-10 mx-auto rounded-[60px]'}`}
      ...
      >
        <div className={` absolute top-0 p-4 flex flex-col justify-center text-white items-center right-0 bottom-0 left-0 bg-black/30 ${rounded && 'container px-4 md:px-10 mx-auto rounded-[60px]'}`}>
          <h1 className="text-xl md:text-6xl  text-yellow font-bold font-poppins text-center capitalize">
            {title}
          </h1>
