        ...
        {data.map((item: any, idx: number) => {
          return (
            <div className={`relative h-[400px] md:h-[600px] rounded-[60px] overflow-hidden `} key={idx}>
              ...
              <div className="absolute max-w-[700px] p-4 w-full top-1/2 flex px-16  md:px-4 flex-col justify-start right-1/2 items-start transform -translate-y-1/2 translate-x-1/2">
